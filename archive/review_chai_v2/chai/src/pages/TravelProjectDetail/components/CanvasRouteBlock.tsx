...
type CanvasRouteBlockProps = {
  node: CanvasRouteNode
  module: TravelModule
  onRemove: (id: string) => void
  isOverlay?: boolean
}

export function CanvasRouteBlock({ node, module, onRemove, isOverlay = false }: CanvasRouteBlockProps) {
  ...
  return (
    <article
      ...
      className={`absolute flex w-[214px] overflow-hidden rounded-[18px] bg-[#FCFBF7] shadow-[0px_6px_16px_rgba(27,29,17,0.08)] transition ${
